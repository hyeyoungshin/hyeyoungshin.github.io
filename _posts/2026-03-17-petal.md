...
Implement parser, type checker, closure conversion, llvm codegen.
In this phase, only deal with pure functions.

### Phase 2: Effect system
Add a small set of monads to the type system.
Candidates are: `Maybe`, `IO`, 
Maybe use Do-notation desugaring as a compiler pass.
Type checker can be extended to track and enforce effect types.
